...
return [
  ...
  'messages' => [
    ...
    'ai_provider_error'         => 'Помилка сервіса AI!',
    'ai_fill_required_fields'   => 'Заповніть обов\'язкові поля перед відправкою промпта',
  ],
'orders' => [
    'statuses' => [
  ...
  'catalog' => [
    'products' => [
      ...
      'fields' => [
        ...
        'is_primary_category'     => 'Основна категорія',
        'manufacturer'            => 'Виробник',
        'manufacturers'           => 'Виробник',
        'is_primary_manufacturer' => 'Основний виробник',
      ...
      'helpers' => [
        ...
        'is_active'               => 'Статус товару задається окремо для кожного магазину',
        ...
        'facet_categories'        => 'Виберіть категорії, в яких відображатиметься товар. Головна категорія товару використовується для створення шляху URL товару',
        'facet_manufacturers'     => 'Виберіть виробників, в яких буде відображено товар. Головний виробник товару відображеється на сторінці товару у вигляді логотипу і посилання',
        ...
        'group_title'             => 'Товари можуть бути прив\'язані до кількох магазинів одночасно і при цьому мати різні ціни, описи, набори опцій та атрибутів і відображатись у різних категоріях кожного магазину',        
      ],
      'buttons' => [
      ...
      'errors' => [
        ...
        'no_primary_category' => 'Виберить головну категорію товару',
        'no_categories'       => 'Створіть категорію, щоб додати до неї товар',
      ]
    ],
    'categories' => [
      ...
      'helpers' => [
        ...
        'group_title'     => 'Категорії – це основний спосіб груповання товарів. Кожен товар може відображатися в кількох категоріях',
      ],
    ],
    'manufacturers' => [
      ...
      'helpers' => [
        ...
        'group_title'     => 'Виробники товару відображаються на сторінці товару у вигляді логотипу та посилання, та у фільтрі товарів. У товару може бути кілька пов\'язаних виробників, але тільки основний буде відображено на сторінці товару',
      ],
    ],
    'attributes' => [
      ...
      'helpers' => [
        'title_helper'          => 'Атрибути - це незмінні властивості товару. Відображаються на сторінці товару у вигляді таблиці і в фільтрі товарів',
    ...
    'tags' => [
      ...
      'helpers' => [
        ...
        'group_title'     => 'Теги потрібні для угруповання товарів, коли потрібно об\'єднати товари в групу і створити для них посадкову сторінку. Теги також відображаются в фільтрі товарів',
      ],
    ],
    'facet_pages' => [
      ...
      'helpers' => [
        ...
        'group_title'       => 'Сторінки фільтра – це посадкові сторінки для більш точного охоплення SEO запитів. Сторінка фільтра дозволяє вибрати комбінацію з основного фільтра (категорії або виробник) та одного або кількох додаткових фільтрів (опції, атрибути, теги) та створити для цієї комбінації сторінку з усіма атрибутами статичної сторінки: Title, докладний опис',
      ]
    ],
    'facets' => [
      'types' => [
  ...
  'common' => [
    ...
    'buttons' => [
      ...
      'ai_action_append'  => 'Додати в кінець',
    ],
  ],
  'design' => [
    'menu_editor' => [
  ...
  'stores' => [
    ...
    'store_settings' => [
      'tabs' => [
        'ai_settings' => [
          'tab_label' => 'Налаштування AI',
          'labels' => [
            'prompt_settings'   => 'Налаштування промптів',
            'providers'         => 'Провайдери послуг',
            'name'              => 'Назва промпту',
            'prompt'            => 'Промпт',
            'prompt_text'       => 'Текст промпту',
            'prompt_extra'      => 'Додатковий промпт',
            'api_key'           => 'Ключ API',
            'provider'          => 'Провайдер',
            'endpoint'          => 'URL-адреса ендпоїнту',
            'model'             => 'Модель'
          ],
          'helpers' => [
            'prompt_settings'   => 'Створіть тут готові промпти. Ви зможете обрати один із них або відредагувати його перед відправленням запиту до AI',
            'providers'         => 'Додайте сюди провайдера послуг AI. Ви можете додати кілька провайдерів і пізніше обрати потрібний у модальному вікні на будь-якій сторінці редагування',
            'prompt'            => 'Промпт для моделі AI',
          ],
          'buttons' => [
            'add_prompt'        => 'Додати новий промпт',
            'add_provider'      => 'Додати провайдера',
          ],
          'columns' => [
            'prompts'           => 'Промпти',
            'providers'         => 'Провайдери',
            'provider_settings' => 'Налаштування',
            'is_default'        => 'За замовчуванням',
          ],
        ],
      ],
    ...
    'info_pages' => [
      ...
      'helpers' => [
        'group_title' => 'Інфо сторінки - це сторінки з основною інформацією про магазин, такою як контакти, правила доставки та оплати, правові положення'
      ]
    ],
  ],
