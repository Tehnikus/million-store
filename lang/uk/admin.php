...
return [
  ...
  'global' => [
    ...
    'store_wizard' => [
      ...
      'messages' => [
        'currency_language_hint' => 'Валютою за замовчуванням для цієї мови буде встановлено :currency з попереднього кроку. Ви завжди можете змінити це налаштування в панелі адміністратора у розділі «Глобальні/Мови»',
        'currency_country_hint'  => 'Валютою за замовчуванням для цієї країни буде встановлено :currency з попереднього кроку. Ви завжди можете змінити це налаштування в панелі адміністратора у розділі «Глобальні/Країни»',
      ],
      'steps' => [
        'currency'  => 'Валюта',
        'language'  => 'Мова',
