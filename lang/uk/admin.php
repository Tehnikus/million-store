  ...
  'seo' => [
    ...
    'meta_editor' => [
      ...
      'helpers' => [
        ...
        'results_table_descriptions'  => 'Виберіть рядки з таблиці вище, натиснувши кнопку "Додати до проміжної таблиці". Рядки, які відображаються тут, можна редагувати по одній або масово, застосувавши формулу генерації. Рядки зберігаються лише після натискання кнопки "Зберегти"',
