...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('product_descriptions', function (Blueprint $table) {
            ...
            $table->foreignId('primary_category_id')->nullable()->constrained('categories')->references('id')->onDelete('set null');
            $table->foreignId('primary_manufacturer_id')->nullable()->constrained('manufacturers')->references('id')->onDelete('set null');
            // Flags
            ...
            $table->jsonb('options_description')->nullable()->default('{}');
            $table->jsonb('attributes_description')->nullable()->default('{}');
